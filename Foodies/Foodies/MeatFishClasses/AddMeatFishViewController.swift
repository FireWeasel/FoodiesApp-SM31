...
class AddMeatFishViewController: UIViewController,UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    {
        self.ref.child("meat").child(name).setValue(value)
    }
