...
class AddFruitViewController: UIViewController, UITextFieldDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate {
    ...
    @IBAction func addImageFromPhone(_ sender: Any) {
        openPhotoLibrary()
    }
    ...
    {
        self.ref.child("fruit").child(name).setValue(value)
    }
